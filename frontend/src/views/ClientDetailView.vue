    ...
    <div v-if="initialLoading" class="space-y-6" aria-busy="true" aria-live="polite">
      <section class="bg-white rounded shadow p-6 space-y-3 animate-pulse">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div class="h-4 w-64 rounded bg-gray-200 md:col-span-2"></div>
          <div class="h-4 w-60 rounded bg-gray-200 md:col-span-2"></div>
        </div>
      </section>
          ...
          <table class="min-w-full text-sm">
            ...
            <tbody>
              <tr v-for="row in 4" :key="row" class="border-b">
                ...
                <td class="py-2 pr-4"><div class="h-4 w-16 rounded bg-gray-200"></div></td>
              </tr>
            </tbody>
          </table>
        </div>
